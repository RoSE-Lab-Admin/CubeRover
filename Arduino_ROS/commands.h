...
#define SET_MOTOR_SPEEDS  'm' // set motor speeds of all 4 motors. arg1 = left motor speed | arg2 = right motor speed | arg3 = accel
#define SET_MOTOR_SPEED   'd' // sets motor speed of 1 motor. arg 1 = motor index (FL,BL,FR,BR) | arg2 = speed | arg 3 = accel
