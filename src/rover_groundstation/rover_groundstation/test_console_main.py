...
class TestConsole(Node):
    def __init__(self):
        ...
        self.test_name =  f"Trial_{int(lin_vel)}cm_{turn_rad}radius_{slope}slope_Trial{int(test_num)}_{datetime.datetime.now().strftime("%m%d%Y_%H_%M_%S")}"
    ...
    def start_lidar(self):
        ...
        self.scanname = self.test_name + "_lidar"
