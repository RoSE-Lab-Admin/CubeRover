...
#functions
    ...
    def get_input(self): #read and returns controller input
        ...
        right_Xaxis = self.controller.get_axis(5) #rX is on axis 5
        right_Yaxis = self.controller.get_axis(2) #rY is on axis 2
        left_Trig = self.controller.get_axis(4) #lT is on axis 4
        right_Trig = self.controller.get_axis(3) #5
