...
void set_motor_speed(int motorIndex, uint32_t speed) {
  ...
  else if (motorIndex == 3 && ROBOCLAW_2) ROBOCLAW_2->SpeedAccelM1(0x80, FR.calcAccel(speed), speed);
  else if (motorIndex == 4 && ROBOCLAW_2) ROBOCLAW_2->SpeedAccelM2(0x80, BR.calcAccel(speed), speed);
}
